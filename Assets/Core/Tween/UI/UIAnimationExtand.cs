...
namespace huqiang
{
    public static class UIAnimationExtand
    {
        ...
        public static UIMove MoveTo(this UIMove ani, Vector3 pos)
        {
            ...
            ani.EndPosition = pos;
            ani.aniType |= UIMove.AniType.Position;
            return ani;
        }
        public static UIMove ScaleTo(this UIMove ani, Vector3 pos)
        {
            ...
            ani.EndScale= pos;
            ani.aniType |= UIMove.AniType.Scale;
            return ani;
        }
        public static UIMove AngleTo(this UIMove ani, Vector3 pos)
        {
            ...
            ani.EndAngle = pos;
            ani.aniType |= UIMove.AniType.Angle;
            return ani;
        }
        public static UIMove SizeTo(this UIMove ani, Vector2 pos)
        {
            ...
            ani.EndSize = pos;
            ani.aniType |= UIMove.AniType.Size;
            return ani;
        }
        ...
        public static UIMove AngleTo(this ModelElement trans, Vector3 pos, float time, bool hide = false, float delay = 0, Action<UIMove> over = null, bool cover = true)
        {
            if (trans == null)
                return null;
            trans.activeSelf = true;
