...
namespace huqiang.UIComposite
{
    ...
    public class ScrollYExtand : UI.UIComposite,AnimatInterface
    {
        ...
        void OrderBody(float os,DataTemplate dat,int index, bool force)
        {
            ...
            Bodys.Add(t);
            //t.target.localPosition.y =  Size.y * 0.5f - os - h * 0.5f;
            //t.target.sizeDelta.y = h;
            t.target.gameObject.SetActive(true);
            //if (dat.Data != null)
        ...
        public void Update(float time)
        {
            ...
            if (hideSect != null)
            {
                ...
                if (hideSect.aniTime > 100)
                    hideSect.aniTime = 100;
                float r = hideSect.aniTime / 100;
                hideSect.ShowOffset = hideSect.Height * r;
                os -= (hideSect.aniTime - a)/ 100 * hideSect.Height;
                if (r == 1)
                {
                    hideSect.Hide = true;
                    hideSect = null;
            ...
            if (showSect != null)
            {
                ...
                if (showSect.aniTime > 100)
                    showSect.aniTime = 100;
                float r = showSect.aniTime / 100;
                r = 1 - r;
