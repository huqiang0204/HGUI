...
namespace huqiang
{
    public partial class Physics2D
    {
        ...
        /// <param name="location"></param>
        /// <returns></returns>
        public static bool PToP3A(Vector3[] A, Vector3[] B, ref Vector3 location)
        {
            //formule
            //A.x+x1*V1.x=B.x+x2*V2.x
            //x2*V2.x=A.x+x1*V1.x-B.x
        ...
        /// <param name="P"></param>
        /// <returns></returns>
        public static bool CircleToPolygon(Vector2 C, float r, Vector3[] P)
        {
            Vector2 A = new Vector2();
            Vector2 B = new Vector2();
        ...
        public unsafe static bool PToP3B(Vector3* A, int aLen, Vector3* B, int bLen)
        {
