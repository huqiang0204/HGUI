...
//#endif
            ...
            if (fonts.Count == 0)
            {
                ...
                def.RequestCharactersInTexture("ABCDEFGUVWXYZ", 512);//OPQUVWXYZ
                //Debug.Log(def.material.mainTexture.width);
                //Debug.Log(def.material.mainTexture.height);
                fonts.Add(def); 
            }
            return fonts[0];
        }
        ...
        protected unsafe void SaveHText(Helper.HGUI.HText src, FakeStruct fake)
        {
        ...
        {
            var src = com.GetComponent<Helper.HGUI.HText>();
            if (src == null)
                return null;
        ...
        public override FakeStruct SaveUI(UIElement com, DataBuffer buffer)
        {
